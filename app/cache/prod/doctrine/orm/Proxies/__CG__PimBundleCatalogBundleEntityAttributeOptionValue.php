 ...
 */
class AttributeOptionValue extends \Pim\Bundle\CatalogBundle\Entity\AttributeOptionValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'option', 'locale', 'value');
        }
     ...
     * {@inheritDoc}
     */
    public function setOption(\Pim\Bundle\CatalogBundle\Model\AttributeOptionInterface $option)
    {
