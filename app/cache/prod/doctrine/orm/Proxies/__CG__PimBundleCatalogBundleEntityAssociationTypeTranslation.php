 ...
 */
class AssociationTypeTranslation extends \Pim\Bundle\CatalogBundle\Entity\AssociationTypeTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'foreignKey', 'label', 'id', 'locale');
        }
