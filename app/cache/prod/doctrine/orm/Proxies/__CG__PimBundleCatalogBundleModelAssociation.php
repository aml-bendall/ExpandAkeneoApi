 ...
 */
class Association extends \Pim\Bundle\CatalogBundle\Model\Association implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'associationType', 'owner', 'products', 'groups', 'groupIds');
        }
    ...
    public function getAssociationType()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAssociationType', array());
     ...
     * {@inheritDoc}
     */
    public function setOwner(\Pim\Bundle\CatalogBundle\Model\ProductInterface $owner)
    {
     ...
     * {@inheritDoc}
     */
    public function hasProduct(\Pim\Bundle\CatalogBundle\Model\ProductInterface $product)
    {
