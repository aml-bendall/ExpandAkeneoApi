 ...
 */
class AssociationType extends \Pim\Bundle\CatalogBundle\Entity\AssociationType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'code', 'locale', 'translations', 'created', 'updated');
        }
