...
namespace Proxies\__CG__\Pim\Bundle\VersioningBundle\Model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Version extends \Pim\Bundle\VersioningBundle\Model\Version implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'author', 'resourceName', 'resourceId', 'snapshot', 'changeset', 'context', 'version', 'loggedAt', 'pending');
        }
    ...
    public function setSnapshot(array $snapshot)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSnapshot', array($snapshot));
