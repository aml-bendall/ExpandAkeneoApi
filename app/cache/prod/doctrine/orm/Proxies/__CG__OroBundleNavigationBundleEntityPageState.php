...
class PageState extends \Oro\Bundle\NavigationBundle\Entity\PageState implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'user', 'pageId', 'pageHash', 'data', 'createdAt', 'updatedAt');
        }
    ...
    public function getPageHash()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPageHash', array());
