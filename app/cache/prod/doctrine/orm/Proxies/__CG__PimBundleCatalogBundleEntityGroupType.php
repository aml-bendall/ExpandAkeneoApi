 ...
 */
class GroupType extends \Pim\Bundle\CatalogBundle\Entity\GroupType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'code', 'variant', 'groups', 'locale', 'translations');
        }
