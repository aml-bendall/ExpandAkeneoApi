 ...
 */
class ProductPrice extends \Pim\Bundle\CatalogBundle\Model\ProductPrice implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'value', 'data', 'currency');
        }
